...
if __name__ == "__main__":
	...
	for arg in sys.argv:
		arg_count+=1
	if arg_count<3 or (sys.argv[2]!= "pubtator" and sys.argv[2]!= "biocxml" and sys.argv[2]!= "biocjson"):
		...
		Bioconcept=""
		if arg_count>=5:
			Bioconcept = sys.argv[4]
		
		SubmitPMIDList(Inputfile,Format,Outfile,Bioconcept)